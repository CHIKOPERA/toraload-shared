...
export enum EventType {
    ...
    PICKUP_PIN_GENERATED = 'PICKUP_PIN_GENERATED',
    PICKUP_PIN_VERIFIED = 'PICKUP_PIN_VERIFIED',
    PICKUP_PIN_FAILED_ATTEMPT = 'PICKUP_PIN_FAILED_ATTEMPT',
    PICKUP_PIN_REGENERATED = 'PICKUP_PIN_REGENERATED',
...
export const VEHICLE_CATEGORIES: Record<VehicleCategory, VehicleCategoryInfo> = {
    [VehicleCategory.TINY_HELPER]: {
        ...
        exampleLoads: ['Small seed bags', 'A few crates of produce', 'Single farm delivery'],
        icon: '🚗',
        sortOrder: 1,
        baseMultiplier: 0.7,
    },
    [VehicleCategory.SMALL_BAKKIE]: {
        ...
        exampleLoads: ['Vegetable crates', 'Seedling trays + tools', 'Small harvest load'],
        icon: '🛻',
        sortOrder: 2,
        baseMultiplier: 1.0,
    },
    [VehicleCategory.MEDIUM_BAKKIE]: {
        ...
        exampleLoads: ['Maize + sunflower bags', 'Irrigation equipment', 'Medium harvest load'],
        icon: '🚙',
        sortOrder: 3,
        baseMultiplier: 1.3,
    },
    [VehicleCategory.SMALL_TRUCK]: {
        ...
        exampleLoads: ['Bulk grain bags', 'Fertiliser + chemicals', 'Large harvest delivery'],
        icon: '🚚',
        sortOrder: 4,
        baseMultiplier: 1.8,
    },
    [VehicleCategory.LARGE_TRUCK]: {
        ...
        capacityHint: '5+ tons',
        exampleLoads: ['Full harvest load', 'Farm equipment relocation', 'Bulk produce to market'],
        icon: '🚛',
        sortOrder: 5,
        baseMultiplier: 2.5,
    },
